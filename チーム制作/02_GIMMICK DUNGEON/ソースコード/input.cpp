...
void UpdateJoyPad(void)
{
	...
	//デバッグ表示
	//PrintDebugProc("コントローラのデバッグ表示\n");
	//PrintDebugProc("コントローラの入力 [ lX ] = %d\n", g_aJoyPad[0].aKeyState.lX);
	//PrintDebugProc("コントローラの入力 [ lY ] = %d\n", g_aJoyPad[0].aKeyState.lY);
	//PrintDebugProc("コントローラの入力 [ lZ ] = %d\n", g_aJoyPad[0].aKeyState.lZ);
	//PrintDebugProc("コントローラの入力 [ lRx ] = %d\n", g_aJoyPad[0].aKeyState.lRx);
	//PrintDebugProc("コントローラの入力 [ lRy ] = %d\n", g_aJoyPad[0].aKeyState.lRy);
	//PrintDebugProc("コントローラの入力 [ lRz ] = %d\n", g_aJoyPad[0].aKeyState.lRz);
	//PrintDebugProc("コントローラの入力 rglSlider [ 0 ] = %d\n", g_aJoyPad[0].aKeyState.rglSlider[0]);
	//PrintDebugProc("コントローラの入力 rglSlider [ 1 ] = %d\n", g_aJoyPad[0].aKeyState.rglSlider[1]);
	//for (int nCnt = 0; nCnt < 4; nCnt++)
	//{
	//	PrintDebugProc("コントローラの入力 rgbwPOV [ %d ] = %d\n", nCnt, g_aJoyPad[0].aKeyState.rgdwPOV[nCnt]);
	//}
	//for (int nCnt = 0; nCnt < 16; nCnt++)
	//{
	//	PrintDebugProc("コントローラの入力 rgbButtons [ %d ] = %d\n", nCnt, g_aJoyPad[0].aKeyState.rgbButtons[nCnt]);
	//}
	//PrintDebugProc("コントローラの入力 CrossTrigger = %d\n", g_aJoyPad[0].CrossTrigger);
	//PrintDebugProc("コントローラの入力 nStickAngleL = %d\n", g_aJoyPad[0].nStickAngleL);
	//PrintDebugProc("コントローラの入力 nStickAngleR = %d\n", g_aJoyPad[0].nStickAngleR);
	//if (g_aJoyPad[0].nStickTriggerL != 1000)
	//{
	//	PrintDebugProc("コントローラの入力 nStickTriggerR = %d\n", g_aJoyPad[0].nStickTriggerR);
	//	PrintDebugProc("コントローラの入力 nStickTriggerL = %d\n", g_aJoyPad[0].nStickTriggerL);
	//}
}
...
{
	D3DXVECTOR3 correction = GetMouseSensCorrection();
	return D3DXVECTOR3(((float)g_Mouse.MouseState.lX) * correction.x, ((float)g_Mouse.MouseState.lY) * correction.y, ((float)g_Mouse.MouseState.lZ));
}
