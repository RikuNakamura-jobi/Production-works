...
void InitPause(void)
{
	...
	for (nCntPause = 0; nCntPause < NUM_PAUSE; nCntPause++)
	{
		...
		{
			//頂点座標の設定
			pVtx[0].pos = D3DXVECTOR3(460.0f, 200.0f * (nCntPause - 1) + 100.0f, 0.0f);
			pVtx[1].pos = D3DXVECTOR3(780.0f, 200.0f * (nCntPause - 1) + 100.0f, 0.0f);
			pVtx[2].pos = D3DXVECTOR3(460.0f, (200.0f * (nCntPause - 1)) + 160.0f, 0.0f);
			pVtx[3].pos = D3DXVECTOR3(780.0f, (200.0f * (nCntPause - 1)) + 160.0f, 0.0f);
