...
void InitScore(void)
{
	...
	{
		//頂点座標の設定
		pVtx[0].pos.x = g_posScore.x + (20.0f * nCntScore);
		pVtx[0].pos.y = g_posScore.y;
		pVtx[0].pos.z = 0.0f;

		pVtx[1].pos.x = g_posScore.x + (20.0f * nCntScore) + 20.0f;
		pVtx[1].pos.y = g_posScore.y;
		pVtx[1].pos.z = 0.0f;

		pVtx[2].pos.x = g_posScore.x + (20.0f * nCntScore);
		pVtx[2].pos.y = g_posScore.y + 40.0f;
		pVtx[2].pos.z = 0.0f;

		pVtx[3].pos.x = g_posScore.x + (20.0f * nCntScore) + 20.0f;
