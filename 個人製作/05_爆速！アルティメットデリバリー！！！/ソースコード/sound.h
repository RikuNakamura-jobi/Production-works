...
public:
	...
	enum SOUND_LABEL
	{
		...
		SOUND_LABEL_SE_CHAIN,			// 弾発射音1
		SOUND_LABEL_SE_CHAINJUMP,		// 弾発射音1
		SOUND_LABEL_SE_DASH,			// 弾発射音1
		SOUND_LABEL_SE_BOOST,			// 弾発射音1
		SOUND_LABEL_SE_WIND_DASH,		// 弾発射音1
		SOUND_LABEL_SE_WIND_WALK,		// 弾発射音1
		SOUND_LABEL_SE_YES,				// 弾発射音1
		SOUND_LABEL_SE_DAMAGE,			// 弾発射音1
		SOUND_LABEL_SE_HIT,				// 弾発射音1
		SOUND_LABEL_SE_DASH_OLD,			// 弾発射音1
