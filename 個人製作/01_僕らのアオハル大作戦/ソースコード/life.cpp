...
void InitLife(void)
{
	...
	pVtx[1].pos.x = g_posLife.x + 100.0f;
	pVtx[1].pos.y = g_posLife.y;
	pVtx[1].pos.z = 0.0f;

	pVtx[2].pos.x = g_posLife.x;
	pVtx[2].pos.y = g_posLife.y + 20.0f;
	pVtx[2].pos.z = 0.0f;

	pVtx[3].pos.x = g_posLife.x + 100.0f;
	pVtx[3].pos.y = g_posLife.y + 20.0f;
	pVtx[3].pos.z = 0.0f;
...
void SetLife(int nLife)
{
	...
	pVtx[1].pos.x = g_posLife.x + g_nLife;
	pVtx[1].pos.y = g_posLife.y;
	pVtx[1].pos.z = 0.0f;
	...
	pVtx[3].pos.x = g_posLife.x + g_nLife;
	pVtx[3].pos.y = g_posLife.y + 20.0f;
	pVtx[3].pos.z = 0.0f;

	//テクスチャ座標の設定
	pVtx[0].tex = D3DXVECTOR2(0.0f, 0.0f);
	pVtx[1].tex = D3DXVECTOR2(0.001f * g_nLife, 0.0f);
	pVtx[2].tex = D3DXVECTOR2(0.0f, 1.0f);
	pVtx[3].tex = D3DXVECTOR2(0.001f * g_nLife, 1.0f);
