...
void InitResult(void)
{
	...
	D3DXCreateTextureFromFile(pDevice,
		"data\\TEXTURE\\aoharuBGResult000.png",
		&g_apTextureResult[0]);

	D3DXCreateTextureFromFile(pDevice,
		"data\\TEXTURE\\aoharuResult000.png",
		&g_apTextureResult[1]);

	D3DXCreateTextureFromFile(pDevice,
		"data\\TEXTURE\\aoharuResult001.png",
		&g_apTextureResult[2]);
...
void UpdateResult(void)
{
	...
	if ((GetKeyboardTrigger(DIK_BACKSPACE) == true && fade == FADE_NONE) || (g_nCounterTime <= 0 && fade == FADE_NONE))
	{
		//モード設定
		SetFade(MODE_SELECT);
	}
